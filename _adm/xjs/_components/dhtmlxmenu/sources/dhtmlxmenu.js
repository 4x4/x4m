	...
	*/
	...
	this._doOnClick = function(id, type, casState) {
		...
		//
            ...
            if(typeof this.itemPull[this.idPrefix+id]["cfunc"]=='function')
            {
                if(this.contextID)this.contextMenuZoneId=this.contextID;
                if (this._isContextMenuVisible() && this.contextAutoHide) this._hideContextMenu();
                this.itemPull[this.idPrefix+id]["cfunc"](id, this.contextMenuZoneId, casState);
...
*   @type: public
*/
dhtmlXMenuObject.prototype.addNewSibling = function(nextToId, itemId, itemText, disabled, imgEnabled, imgDisabled,cfunc) {
	...
	// console.log(id, ",", parentId)
	this._addItemIntoGlobalStrorage(id, parentId, itemText, "item", disabled, imgEnabled, imgDisabled,cfunc);
...
*   @type: public
*/
dhtmlXMenuObject.prototype.addNewChild = function(parentId, pos, itemId, itemText, disabled, imgEnabled, imgDisabled,cfunc) {
	if (parentId == null) {
		if (this.context) {
			parentId = this.topId;
		} else {
			this.addNewSibling(parentId, itemId, itemText, disabled, imgEnabled, imgDisabled,cfunc);
	...
	this._addItemIntoGlobalStrorage(itemId, parentId, itemText, "item", disabled, imgEnabled, imgDisabled,cfunc);
...
/* add item to storage */
dhtmlXMenuObject.prototype._addItemIntoGlobalStrorage = function(itemId, itemParentId, itemText, itemType, disabled, img, imgDis,cfunc) {
	var item = {
		id:	itemId,
		title:	itemText,
		imgen:	(img!=null?img:""),
