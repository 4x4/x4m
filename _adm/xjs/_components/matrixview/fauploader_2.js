...
function processFile(file, context) 
{
                        ...
                        context.options.resultsList.appendChild(bli);
                        
                        var xhr = new XMLHttpRequest(),
                        fileUpload = xhr.upload;
                        fileUpload.log=file.fileName;
                        fileUpload.container=bli;
                        fileUpload.addEventListener("progress", 
                        function(event){
                    ...
                    //                        loaderIndicator.textContent = percentage + "%";
                      //                  }
                        ...
                        , false);
                        fileUpload.addEventListener("load", context.loadedXHR, false);
                        fileUpload.addEventListener("error", context.uploadError, false);
  ...
  //                  }
        ...
        uploadError:function (error) 
         ...
         loadFiles:function()
         {
              ...
              {
                      new  processFile(this.input.files[i],this);
              }
