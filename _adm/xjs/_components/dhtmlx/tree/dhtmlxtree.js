...
dhtmlXTreeObject.prototype._doContClick=function(ev){
    ...
    if (!this.callEvent("onRightClick",[obj.id,ev]))
        ...
        if (this._acMenu){
            ...
            if (!(this.callEvent("onBeforeContextMenu", [obj.id]))) return true; 	
...
*   @topic: 0
*/
function dhtmlXTreeItemObject(itemId,itemText,parentObject,treeObject,actionHandler,mode,obj_type){
   this.htmlNode="";
   this.acolor="";
   this.scolor="";
   this.tr=0;
...
*     @topic: 2
*/
   dhtmlXTreeObject.prototype._attachChildNode=function(parentObject,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,childs,beforeNode,afterNode,obj_type){
		...
		if (!(n=this._idpull[itemId]) || n.span!=-1){
         	n=Nodes[Count]=new dhtmlXTreeItemObject(itemId,itemText,parentObject,this,itemActionHandler,1,obj_type);
...
*     @topic: 2  
*/
   dhtmlXTreeObject.prototype.insertNewChild=function(parentId,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,children,obj_type){
      return this.insertNewItem(parentId,itemId,itemText,itemActionHandler,image1,image2,image3,optionStr,children,obj_type);
   }   
/**  
*     @desc: parse xml
*     @type: private
...
//#}
    	          ...
    	          if (this.waitUpdateXML){
				  		if (this._globalIdStorageFind(a.id))
		                    ...
		                    var newNode=this._attachChildNode(temp,a.id,a.text,0,a.im0,a.im1,a.im2,zST.join(","),a.child,0,preNode,a.obj_type);
							preNode=null;
						}
					 }
                  else
                     var newNode=this._attachChildNode(temp,a.id,a.text,0,a.im0,a.im1,a.im2,zST.join(","),a.child,(befNode||0),preNode,a.obj_type);
                  if (a.tooltip)
...
//wrapper
dhtmlXTreeObject.prototype.get_objtype=function(id)
{
    return this.getNodeParam(id,'obj_type');
...
*     @topic: 1
*/
   dhtmlXTreeObject.prototype.getSelectedItemId=function(as_array)
   {
        var str=new Array();
...
dhtmlXTreeObject.prototype.getNodeParam=function(itemId, param)
{
