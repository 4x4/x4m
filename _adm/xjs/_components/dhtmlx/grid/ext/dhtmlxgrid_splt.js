...
//added by abiatec
dhtmlXGridObject.prototype._setRowHeight=function(id,height){
    if (!this.rowsAr[id] || !this._fake.rowsAr[id]) return;
    this._fake.rowsAr[id].style.height=(height)+"px";
    this.rowsAr[id].style.height=height+"px";
    if (window._KHTMLrv) this.rowsAr[id].childNodes[this._fake._cCount].style.height=this._fake.rowsAr[id].firstChild.style.height=height;
}
