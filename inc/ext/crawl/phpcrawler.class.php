...
// 2007/01/03
//
// Copyright (C) 2003 Uwe Hunfeld (phpcrawl@cuab.de)
//
...
{  
  ...
  //X3M
  //timeLimit for endless crawling 
  var $timeLimit=0;
  ...
  function initCrawler($prevent_init_request=false)
  {
  ...
  {  
    ...
    if($this->timeLimit)
    {
        $stop_time=$starting_time+$this->timeLimit;
    }
